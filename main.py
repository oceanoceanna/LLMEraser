...
def load_callbacks(args):
    ...
    filename_format = f'{args.ratio}-{args.mode_type}-{args.lora_r}-{{epoch:02d}}-{{metric:.3f}}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode_type', default='normal', type=str)

    parser.add_argument("--x_lr", type=float, default=0.0001)
    parser.add_argument("--x_init", type=float, default=0.001)
    parser.add_argument("--x_adjust", type=float, default=0)
    parser.add_argument("--x_iter", type=int, default=200)
    parser.add_argument("--x_batch", type=int, default=2)
